...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    email: 'bhaskarnani073@gmail.com',
    phone: '+91 6303431098',
    address: {
      line1: 'Kummar Bazar , Taduvai',
      line2: 'Jangareddygudem , AP'
    },
    gender: 'Male',
    dob: '12-07-2004'
  })
    ...
    <div className='max-w-lg flex-col gap-2 text-sm mt-4'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          {
            isEdit
              ? <input className='bg-gray-100 max-w-52 outline-none' type="number" value={userData.phone} onChange={e => setUserData(prev => ({ ...prev, phone: e.target.value }))} />
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          {
            isEdit ? <input className='max-w-28 bg-gray-100 outline-none' type='date' value={userData.dob} onChange={(e)=> setUserData(prev => ({...prev,dob:e.target.value}))} />
